/// <mls fileReference="_102030_/l2/petShopStripe/web/shared/adminMetricsPage.defs.ts"  enhancement="_blank"/>
export const skill = `
## Pages spec
\`\`\`JSON
...
## Contracts
\`\`\`JSON
    [[(_102030_/l2/petShopStripe/web/contracts/adminMetricsPage.ts)]]
\`\`\`
`;
