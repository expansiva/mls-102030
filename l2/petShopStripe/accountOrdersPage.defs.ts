...
export const materializeIndex = [
  {
    ...
    "defsPath": "_102030_/l1/petShopStripe/layer_2_controllers/accountOrdersPage.defs.ts",
    "skillPath": "_102020_/l2/agentMaterializeSolution/skills/genContract.ts",
    "moduleName": "petShopStripe",
    "outputPath": "_102030_/l2/petShopStripe/web/contracts/accountOrdersPage.ts",
    "dependsOn": [],
    "specUpdatedAt": "2026-06-09T10:38:19Z"
  },
  {
    "id": "shared",
    "agent": "agentL2MaterializeSharedPage",
    "defsPath": "_102030_/l2/petShopStripe/web/shared/accountOrdersPage.defs.ts",
    "moduleName": "petShopStripe",
    "outputPath": "accountOrdersPage.ts",
    "dependsOn": [
      "contract"
    ],
    "specUpdatedAt": "2026-06-09T10:38:19Z"
  },
  {
    ...
    "defsPath": "_102030_/l2/petShopStripe/web/desktop/page11/accountOrdersPage.defs.ts",
    "moduleName": "petShopStripe",
    "outputPath": "accountOrdersPage.ts",
    "dependsOn": [
      "contract",
